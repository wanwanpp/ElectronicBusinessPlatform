...
//                alert("colorId is "+colorId+"     size is "+id);
                //修改市场价
                $("#market_price").html('${sku.marketPrice}');
                //售价
                $("#sku_price").html('${sku.skuPrice}');
...
<div class="w ofc mt">
    ...
    <div class="r" style="width: 640px">
        <ul class="uls form">
            ...
            <li><label>巴 巴 价：</label><span class="word"><b class="f14 red mr" id="sku_price">￥128.00</b>(市场价:<del id="market_price">￥150.00</del>)</span>
            </li>
            <li><label>商品评价：</label><span class="word"><span class="val_no val3d4" title="4分">4分</span><var
                    class="blue">(已有888人评价)</var></span></li>
            <li><label>运　　费：</label><span class="word" id="delive_fee">10</span>元</li>
            ...
            <li id="sizes"><label>尺　　码：</label>
                <a href="#none" class="not-allow" id="S" onclick="sizeToRed(this,'S')">S</a>
                <a href="#none" class="not-allow" id="M" onclick="sizeToRed(this,'M')">M</a>
                <a href="#none" class="not-allow" id="L" onclick="sizeToRed(this,'L')">L</a>
                <a href="#none" class="not-allow" id="XL" onclick="sizeToRed(this,'XL')">XL</a>
                <a href="#none" class="not-allow" id="XXL" onclick="sizeToRed(this,'XXL')">XXL</a>
            </li>
            ...
            <li class="submit"><input type="button" value="" class="hand btn138x40"
                                      onclick="buy(${product.id});"/><input type="button" value=""
                                                                            class="hand btn138x40b"
                                                                            onclick="addCart(${product.id})"/></li>
        </ul>
    </div>
</div>
<div class="w ofc mt">
    ...
    <div class="r wr">
        ...
        <div class="box bg_white ofc">
            <div id="detailTab1" class="detail">
                <img src="/res/img/pic/p800b.jpg"/><img src="/res/img/pic/p800a.jpg"/><img
                    src="/res/img/pic/p800c.jpg"/><img src="/res/img/pic/p800d.jpg"/>
            </div>
