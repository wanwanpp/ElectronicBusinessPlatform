        ...
        <form id="jvForm" action="/shopping/login.shtml" method="post">
            ...
            <ul class="uls form">
                ...
                <li><label for="captcha">验证码：</label>
                    ...
                    <img src="/captcha.svl" onclick="this.src='/captcha.svl?d='+new Date()" class="code" alt="换一张"/>
                    <a href="javascript:void(0);" onclick="$('.code').attr('src','/captcha.svl?d='+new Date())"
                       title="换一张">换一张</a>
                </li>
                <li><label>&nbsp;</label><input type="submit" value="登 录" class="hand btn66x23"/>
